...
def prep_data(data, covariates, data_start, train = True):
    ...
    # print("COVARIATES SHAPE =" + str(covariates.shape))
    # print("train: ", train)
    ...
    for series in trange(num_series):
        ...
        for i in range(windows_per_series[series]):
            ...
            # if(i == 0):
                # print("X values are =" + str(x_input[0,:, 0]))
                # print("Y values are =" + str(label[0,:]))
...
if __name__ == '__main__':
    ...
    name = 'Multivariate_Data_Added_Holidays.csv'
    save_name = 'elect'
    window_size = 15
    stride_size = 1
    num_covariates = 4
 #    train_start = '2012-01-07 00:00:0000'
 #    train_end = '2018-03-21 00:00:0000'
 #    test_start = '2018-03-21 00:00:0000'
 # #need additional 7 days as given info
 #    test_end = '2020-12-28 00:00:0000'
    ...
    columns_titles = ["Price (Euros)", "Discount",
       ...
       "New Year's Day (Observed)", "None", "Veterans Day",
       "Washington's Birthday","sales_units"]
